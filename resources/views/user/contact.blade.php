    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center" style="margin-top: 50px; margin-bottom: 50px;">
                ...
                @if(session('success'))
                    <div class="alert alert-success alert-dismissible fade show mx-auto" role="alert" style="max-width: 700px; border-radius: 10px;">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container" style="padding: 20px; border-right: 1px solid #eee;">
                        {{-- Form Action aur Method update kiya gaya hai --}}
                ...
                <div class="col-md-6">
                    <div class="map_container" style="padding: 20px;">
                        <div style="border-radius: 15px; overflow: hidden; border: 1px solid #eee; box-shadow: 0 10px 20px rgba(0,0,0,0.05);">
                            <iframe 
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117506.38131349141!2d72.50762463297594!3d23.02012028612716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e848aba5bd449%3A0x4fccd1170affdf2!2sAhmedabad%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1712123456789!5m2!1sen!2sin" 
                        ...
                        <div class="row mt-4 px-2">
                            ...
                            <div class="col-6">
                                ...
                                <p style="color: #777; font-size: 14px;">hello@vegerestaurant.com<br>+91 98765 43210</p>
                            </div>
                        </div>
                    </div>
                </div>
